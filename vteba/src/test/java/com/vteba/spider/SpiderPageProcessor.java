...
public class SpiderPageProcessor implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new SpiderPageProcessor()).addUrl("http://list.sososteel.com/res/p--------------------------------1.html");
...
//        spider.test();
    ...
    public static void dom4jxml(String xml) {
    	xml = xml.replace("&nbsp;", " ");
    	...
    	try {
        	...
        	int i = 1;
        	for (Element trElement : trList) {
        		System.out.println(trElement.getTextTrim());
        		List<Element> tdList = null;
        		if (i++ == 1) {
        			tdList = trElement.elements("th");
        		} else {
        		...
        		for (Element tdElement : tdList) {
        			...
        			if (value == null || value.equals("")) {
        				...
        				if (href == null) {
        					Element div = tdElement.element("div");
        					System.out.println(div.getTextTrim());
        				} else {
        					System.out.println(href.getTextTrim());
        				}
        			}
