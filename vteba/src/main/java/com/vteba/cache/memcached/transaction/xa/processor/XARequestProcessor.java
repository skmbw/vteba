...
import com.vteba.cache.memcached.transaction.xa.EhcacheXAException;
import com.vteba.cache.memcached.transaction.xa.EhcacheXAResourceImpl;
...
public class XARequestProcessor {
    ...
    public int process(XARequest request) throws XAException {
        ...
        if (xaResponse.getXaException() != null) {
            cleanupThread(request.getXid());
            throw new EhcacheXAException("XA " + request.getRequestType().toString() +
