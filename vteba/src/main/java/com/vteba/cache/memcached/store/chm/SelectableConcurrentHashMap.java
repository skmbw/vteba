package com.vteba.cache.memcached.store.chm;
...
import com.vteba.cache.memcached.pool.sizeof.annotations.IgnoreSizeOf;

/**
 * SelectableConcurrentHashMap subclasses a repackaged version of ConcurrentHashMap
 * it allow efficient random sampling of the map values.
 * <p>
...
public class SelectableConcurrentHashMap {
    ...
    protected static final Element DUMMY_PINNED_ELEMENT = new Element("", new DummyPinnedValue());
    ...
    public SelectableConcurrentHashMap(PoolAccessor<PoolableStore> poolAccessor, boolean elementPinningEnabled, 
    		int initialCapacity, float loadFactor, int concurrency, final long maximumSize) {
    ...
    public Set<Object> pinnedKeySet() {
