 ...
 *
 * @author Greg Luck
 * @version $Id: ClassLoaderUtil.java 5631 2012-05-10 08:31:33Z teck $
 */
public final class ClassLoaderUtil {
     ...
     * @throws CacheException if instance cannot be created due to a missing class or exception
     */
    public static Object createNewInstance(String className, @SuppressWarnings("rawtypes") Class[] argTypes, Object[] args) throws CacheException {
        Class<?> clazz;
        Object newInstance;
        try {
