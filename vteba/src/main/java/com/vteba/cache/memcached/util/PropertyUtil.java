 ...
 * Property utilities.
 * @author Greg Luck
 * @version $Id: PropertyUtil.java 5631 2012-05-10 08:31:33Z teck $
 */
public final class PropertyUtil {
     ...
     * @return null if their is no property for the key, or their are no properties
     */
    public static String extractAndLogProperty(String name, @SuppressWarnings("rawtypes") Map properties) {
        if (properties == null || properties.size() == 0) {
            return null;
        }
        String foundValue = (String) properties.get(name);
