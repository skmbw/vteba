...
import com.vteba.cache.memcached.util.MemoryUnit;
...
final class AgentLoader {
    ...
    private static final String INSTRUMENTATION_INSTANCE_SYSTEM_PROPERTY_NAME = "com.vteba.cache.memcached.sizeof.agent.instrumentation";
    private static final String SIZEOF_AGENT_CLASSNAME = "com.vteba.cache.memcached.pool.sizeof.SizeOfAgent";
    ...
    private static void warnIfOSX() {
        if (JvmInformation.isOSX() && System.getProperty("java.io.tmpdir") != null) {
            LOGGER.warn("Loading the SizeOfAgent will probably fail, as you are running on Apple OS X and have a value set for java.io.tmpdir\n" +
                        ...
                        + com.vteba.cache.memcached.pool.sizeof.AgentSizeOf.BYPASS_LOADING + "'  to true");
        }
    }
