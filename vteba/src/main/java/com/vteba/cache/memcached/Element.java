...
import com.vteba.cache.memcached.util.TimeUtil;

/**
 * 封装缓存元素
 * @author yinlei
 * date 2012-11-24 下午10:37:00
 */
public class Element implements Serializable, Cloneable {

	private static final long serialVersionUID = -49281744750128584L;
	
	private final String key;//缓存键
	private final Object value;//缓存值
	private int cacheTimeSeconds;//缓存时间：秒
	private static final Logger LOG = LoggerFactory.getLogger(Element.class);
	
	private static final boolean ELEMENT_VERSION_AUTO = Boolean.getBoolean("com.skmbw.cache.memcached.element.version.auto");
	/**
    ...
    public Element(final Serializable key, final Serializable value) {
        this((String) key, (Object) value, 1L);

    }
    
    public Element(final String key, final Serializable value) {
        this(key, (Object) value, 1L);

    }
    
    public Element(final Serializable key, final Serializable value, final long version) {
        this((String) key, (Object) value, version);
    ...
    public Element(final String key, final Object value, final long version) {
    	this.key = key;
    	this.value = value;
	...
	public Element(final String key, final Object value, final long version, final long creationTime,
	...
	/**
	 * 获得元素key，同getObjectKey()
	 * @author yinlei
	 * date 2012-12-9 下午2:57:27
	 */
    ...
    public final Object clone() throws CloneNotSupportedException {
        ...
        try {
            Element element = new Element(deepCopy(key).toString(), deepCopy(value), version);
